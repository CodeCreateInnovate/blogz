...
def login():
    ...
    if request.method == 'POST':
        ...
        if user and check_pw_hash(password, user.pw_hash):
            ...
            return redirect('/newpost')
        if not user:
            return render_template('login.html', username_error="Username Invalid.")
        else:
            return render_template('login.html', password_error="Username or password was invalid.")
...
def newpost():
    ...
    if title == "":
        title_error = "What?! No title? You must be from Cleveland."
    if body == "":
        body_error = "Ummm, You have to type something here! DUH!!."
